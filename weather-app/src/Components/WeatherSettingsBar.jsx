...
const WeatherSettingsBar = () => {
  ...
  const handleLocationChange = (e) => {
    const location = defaultLocations.find(loc => loc.name === e.target.value);
    setSettings(prev => ({
      ...prev,
        ...
        <Row className="align-items-center">
          <Col xs={12} md={9}>
            <div className="d-flex gap-2 flex-wrap">
              <Button
                variant={settings.showTemperature ? "primary" : "outline-secondary"}
              ...
              <Button
                variant={settings.showCondition ? "primary" : "outline-secondary"}
